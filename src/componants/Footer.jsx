  ...
  return (
    <div>
        <Container>
            ...
            <div className='text-white flex justify-center lg:gap-x-10 gap-x-5 lg:mb-20 mb-8'>
            ...
            <p className='text-center text-[#767676] font-Josefin font-light lg:text-lg text-base lg:leading-7 lg:pb-10 pb-2'>Made with ❣️ by     
